...
// Created: 10/20/2010 9:54:14 PM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcsx2yobi00000w45we0xdcvj_6x2g";
	this.domain="statse.webtrendslive.com";
	this.timezone=-5;
	this.fpcdom=".pncsites.com";
	this.onsitedoms="";
	this.downloadtypes="xls,doc,pdf,txt,csv,zip,mp3,xlxs,docx";
