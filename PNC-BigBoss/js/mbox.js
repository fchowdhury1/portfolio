...
if (typeof mboxVersion == 'undefined') {
 ...
 var mboxFactoryDefault = new mboxFactory('pncnationalbank.tt.omtrdc.net', 'pncnationalbank',
 'default');
};
...
if (mboxGetPageParameter("mboxDebug") != null ||
 ...
 + '"http://admin3.testandtarget.omniture.com/admin/mbox/mbox_debug.jsp?mboxServerHost=pncnationalbank.tt.omtrdc.net'
 + '&clientCode=pncnationalbank"><' + '\/scr' + 'ipt>');
};
