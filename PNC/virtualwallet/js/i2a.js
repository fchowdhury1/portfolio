...
function pixel_conversion(pageAction)
{
        var dt = new Date();
        var ts = (Math.round(dt.getTime()/1000)).toString() + (Math.random()*100).toString();
       
	var icstring =".ic-live.com/goat.php?cID=1645&cdid=5207&rand="+ts+"&campID=8";
	...
	if (locHttp.toLowerCase( ) == "http")  { prefix="http://1645"+icstring+"";}
